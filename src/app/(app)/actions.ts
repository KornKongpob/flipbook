...
export async function saveStyleOptionsAction(formData: FormData) {
  ...
  await updateJobStyleOptions(
    ...
    mergeCatalogStyleOptions({
      ...
      showSlabPrices: formData.get("showSlabPrices") === "on",
      showSlabQuantity: formData.get("showSlabQuantity") === "on",
      ...
      slabPriceFontSize: formData.get("slabPriceFontSize"),
      ...
      slabPriceColor: formData.get("slabPriceColor"),
